...
export function Sidebar({ currentPage, onNavigate }: SidebarProps) {
  ...
  return (
    <div className="w-64 bg-gradient-to-b from-blue-600 to-blue-800 h-screen sticky top-0 flex flex-col shadow-xl">
      {/* Brand Header */}
      <div className="p-6 border-b border-blue-500">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-blue-200 text-xs">Inventory System</p>
          </div>
        </div>
      </div>
