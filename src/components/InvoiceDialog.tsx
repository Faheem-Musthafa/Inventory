    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <div id="invoice-print-content" style={{ display: 'none' }}>
          ...
          <div className="table-info">TABLE {order.id.slice(-1)}</div>
          
          <div className="order-details">
            <div className="order-row">
              <span>Number of Covers: 1</span>
              <span>Staff: {order.customer_name}</span>
            </div>
            <div className="order-row">
          ...
          <div className="footer">
            ...
            <div>@{settings.storeEmail.split('@')[0]}</div>
          </div>
        </div>
        ...
        <div className="py-4 max-w-sm mx-auto">
          ...
          <div className="text-center mb-4 pb-3 border-b-2 border-dashed">
            ...
            <p className="text-xs text-gray-600">TRN: {settings.storePhone}</p>
          </div>
          ...
          <div className="text-center font-bold text-lg mb-3">TABLE {order.id.slice(-1)}</div>
          ...
          <div className="text-center mt-4 pt-3 border-t border-dashed border-gray-400 text-xs">
            ...
            <p>@{settings.storeEmail.split('@')[0]}</p>
          </div>
